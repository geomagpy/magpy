...
class LemiProtocol(LineReceiver):
    ...
    def processLemiData(self, data):
        ...
        header = "LemiBin %s %s %s %s %s %s %d" % (self.sensor, '[x,y,z,t1,t2]', '[X,Y,Z,T_sensor,T_elec]', '[nT,nT,nT,deg_C,deg_C]', '[0.001,0.001,0.001,100,100]', packcode, struct.calcsize(packcode),'\n')
