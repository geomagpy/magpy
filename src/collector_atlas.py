...
if __name__ == '__main__':
    ...
    clientname = 'atlas'
    factory1 = WampClientFactory("ws://138.22.188.186:9100", debugWamp = False)
    ow.defineclient(clientname)
    factory1.protocol = ow.PubSubClient
    ...
    factory5 = WampClientFactory("ws://138.22.188.181:9100", debugWamp = False)
    env.defineclient(clientname)
    factory5.protocol = env.PubSubClient
    '''
    connectWS(factory1)
    connectWS(factory2)
    #connectWS(factory3)
