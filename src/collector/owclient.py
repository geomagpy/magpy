        ...
        try:
            ...
            if eol == '':
                ...
                if sensorid in ["3AD754010000","0EB354010000"]:
                    sql = "INSERT INTO OW_%s(time, t1, var2, var3, var4, flag, typ) VALUES ('%s', %f, %f, %f, %f, '0000000000000000-', 'ow')" % (sensorid, self.line[0], self.line[1], self.line[3], self.line[4], self.line[5])
                elif sensorid == "05CE54010000" or sensorid == "CBC454010000":
                    sql = "INSERT INTO OW_%s(time, t1, var1, var2, flag, typ) VALUES ('%s', %f, %f, %f, '0000000000000000-', 'ow')" % (sensorid, self.line[0], self.line[1], self.line[2], self.line[3])
                else:
                    sql = "INSERT INTO OW_%s(time, t1, flag, typ) VALUES ('%s', %f, '0000000000000000-', 'ow')" % (sensorid, self.line[0], self.line[1])
                self.line = []
